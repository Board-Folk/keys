/*
  BBCkeyboard - BBC Keyboard Library
...
static const BBCKeymap_t *keymap = NULL;
static volatile bool lshift=false, rshift=false, capslock=false, bbcbreak=false;
