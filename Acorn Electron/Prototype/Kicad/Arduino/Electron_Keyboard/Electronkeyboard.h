...
#ifndef Electronkeyboard_h
#define Electronkeyboard_h
...
#include "WProgram.h"
#endif
#define Electron_KEYMAP_SIZE 	   152 // Size of each array in the key maps

#include "keymapping.h"

#define debug   false    // Set true for serial monitor of Electron keycodes and PS/2 keycodes
...
//Electron Break Key
#define ElectronBREAK_PIN     A0

// Key map value for capslock
#define CAPSLOCK_KEY    0x03 // CapsLock key 

#define ElectronLSHFT  6
#define ElectronRSHFT  6

#define ElectronBREAK  4

class Electronkeyboard {
  public:
    Electronkeyboard();
    
    static void begin(const ElectronKeymap_t &map = ElectronKeymap_main);
};
#endif
